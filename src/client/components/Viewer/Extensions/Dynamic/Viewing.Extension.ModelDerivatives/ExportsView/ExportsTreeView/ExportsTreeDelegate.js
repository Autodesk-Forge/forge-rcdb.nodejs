import ExportsTreeNode from './ExportsTreeNode'
import ContextMenu from './ExportsContextMenu'
import { TreeDelegate } from 'TreeView'

export default class ExportsTreeDelegate extends TreeDelegate {
  /// //////////////////////////////////////////////////////
  //
  //
  /// //////////////////////////////////////////////////////
  ...
  /// //////////////////////////////////////////////////////
  createNode (props) {
    const node = new ExportsTreeNode(
      Object.assign({}, props, {
        delegate: this,
        group: true
      }))
