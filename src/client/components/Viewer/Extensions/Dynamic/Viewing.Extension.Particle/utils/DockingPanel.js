...
DockingPanel.prototype.setVisible = function (show) {
  if (show) {
    ...
    if (this.container.dockRight) {
      ...
      if (!wi) { wi = this.container.getBoundingClientRect().width }
      if (wi) { wi2 = parseInt(wi) }
    ...
    if (this.container.dockBottom) {
      ...
      if (!hi) { hi = this.container.getBoundingClientRect().height }
      if (hi) { hi2 = parseInt(hi) }
...
DockingPanel.prototype.initializeMoveHandlers = function (mover) {
  ...
  function handleMove (e) {
    ...
    var minHeight = container.style.minHeight ? parseInt(container.style.minHeight) : self.kMinHeight
    var parentRect = self.getContainerBoundingRect()
...
DockingPanel.prototype.createScrollContainer = function (options) {
  ...
  var classList = scrollContainer.classList
...
DockingPanel.prototype.resizeToContent = function (options) {
  ...
  var panelRect = this.container.getBoundingClientRect()
  var parentRect = this.getContainerBoundingRect()
